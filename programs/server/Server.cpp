...
#undef COLLECT_FLAG
    ...
    const size_t configured_map_key_columns_merge_pool_size
        = static_cast<size_t>(server_settings[ServerSetting::map_key_columns_merge_pool_size]);
    const size_t map_key_columns_merge_pool_size = configured_map_key_columns_merge_pool_size ? configured_map_key_columns_merge_pool_size : 1;
    ...
    auto main_config_reloader = std::make_unique<ConfigReloader>(
        ...
        [&](ConfigurationPtr loaded_config, bool initial_loading)
        {
            ...
            const size_t new_map_key_columns_merge_pool_size = new_server_settings[ServerSetting::map_key_columns_merge_pool_size]
                ? static_cast<size_t>(new_server_settings[ServerSetting::map_key_columns_merge_pool_size])
                : 1;
            getMapKeyColumnsMergeThreadPool().reloadConfiguration(
                new_map_key_columns_merge_pool_size,
                0,
                new_map_key_columns_merge_pool_size);
