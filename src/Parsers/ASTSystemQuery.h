...
public:
    enum class Type : UInt64
    {
        ...
        CANCEL_VIEW,
        TEST_VIEW,
        REFRESH_AUXILIARY_INDEX,
        START_AUXILIARY_INDEX_BUILDS,
        STOP_AUXILIARY_INDEX_BUILDS,
        START_AUXILIARY_INDEX_REMAPS,
        STOP_AUXILIARY_INDEX_REMAPS,
        SYNC_AUXILIARY_INDEX,
        LOAD_PRIMARY_KEY,
        UNLOAD_PRIMARY_KEY,
