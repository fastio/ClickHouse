...
bool ParserDescribeTableQuery::parseImpl(Pos & pos, ASTPtr & node, Expected & expected)
{
    ...
    /// Recognize one of: "TEMPORARY TABLE" (only valid for table-name form),
    /// "REFLECTION" (describe a reflection object), or plain optional "TABLE".
