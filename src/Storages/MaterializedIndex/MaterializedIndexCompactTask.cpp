...
void MaterializedIndexCompactTask::cleanupTemporaryStorages(bool remove_output_storage) noexcept
{
...
void MaterializedIndexCompactTask::cleanupAfterFailedCommit() noexcept
{
    ...
    {
        tryLogCurrentException(__PRETTY_FUNCTION__, "Failed to finalize MaterializedIndex compact entry after commit failure");
    }
}
