...
/** Part of a materialized index backing table.
  ...
  * its on-disk layout is `algorithm_private/`, `locator/` and `coverage.txt`
  ...
  */
class MergeTreeDataPartMaterializedIndex : public IMergeTreeDataPart
{
public:
    MergeTreeDataPartMaterializedIndex(
    ...
    ~MergeTreeDataPartMaterializedIndex() override;
