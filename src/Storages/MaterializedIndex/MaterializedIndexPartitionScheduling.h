...
///       `getMaterializedIndexPhysicalPartitionId`) to that same id.
///
/// Pure helper for `StorageMaterializedIndex::shouldScheduleCompactRebuild`;
/// the size threshold (`materialized_index_compact_min_parts`) and empty-source
