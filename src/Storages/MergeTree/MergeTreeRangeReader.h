...
private:
    ...
    /// Special logic for AuxiliaryIndex: same shape as the vector variant but with an isolated state.
    ...
    void fillDistanceColumnAndFilterForAuxiliaryIndex(Columns & columns, ReadResult & result, ColumnPtr & part_offsets_auto_column);
    ...
    FilterWithCachedCount part_offsets_filter_for_auxiliary_index;
