...
private:
    ...
    /// Special logic for ANNIndex: same shape as the vector variant but with an isolated state.
    ...
    void fillDistanceColumnAndFilterForANNIndex(Columns & columns, ReadResult & result, ColumnPtr & part_offsets_auto_column);
    ...
    FilterWithCachedCount part_offsets_filter_for_ann_index;
