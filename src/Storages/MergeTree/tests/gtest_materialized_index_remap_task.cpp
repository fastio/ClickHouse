...
class RemapOnlyMockAlgorithm : public IMaterializedIndexAlgorithm
{
public:
...
TEST(MaterializedIndexRemapTaskTest, EmptyStagesStateMachineAdvances)
{
...
TEST_F(MaterializedIndexRemapTaskStage4Test, ZeroAlgorithmCalls)
{
    RemapOnlyMockAlgorithm algorithm;
    ...
    /// The mock algorithm is conceptually owned by `StorageMaterializedIndex`
