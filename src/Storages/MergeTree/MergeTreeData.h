...
public:
    ...
    /// a ANNIndex, whose parts are stamped Kind::ANNIndex by
    ...
    /// ANNIndex parts will not be found.
...
protected:
    ...
    /// Catalog-shell forwarding: `ReflectionANNIndex` is itself a
    ...
    friend class ReflectionANNIndex;
