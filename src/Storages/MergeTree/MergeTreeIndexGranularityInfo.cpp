...
{
    /// MaterializedIndex parts carry no mark files at all, so the
    ...
    if (part_type == MergeTreeDataPartType::MaterializedIndex)
        return;
...
std::string MarkType::getFileExtension() const
{
    ...
    switch (part_type)
    {
        ...
        case MergeTreeDataPartType::MaterializedIndex:
            throw Exception(ErrorCodes::LOGICAL_ERROR,
                "MaterializedIndex parts have no mark files; getFileExtension is not applicable");
