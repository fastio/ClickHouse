...
AlgorithmPartCompatibility IANNIndexAlgorithm::checkPartCompatibility(const IDataPartStorage & storage) const
{
...
std::vector<AlgorithmPrivatePath> IANNIndexAlgorithm::getAlgorithmPrivatePaths(const IDataPartStorage &) const
{
    return {};
}
