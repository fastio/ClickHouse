...
///       `getANNIndexPhysicalPartitionId`) to that same id.
///
/// Pure helper for `ReflectionANNIndex::shouldScheduleCompactRebuild`;
/// the size threshold (`ann_index_compact_min_parts`) and empty-source
