...
class StorageSystemMaterializedIndexParts final : public IStorageSystemOneBlock
{
public:
    StorageSystemMaterializedIndexParts(const StorageID & storage_id_, ColumnsDescription columns_description_);

    std::string getName() const override { return "SystemMaterializedIndexParts"; }
