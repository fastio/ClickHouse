...
class StorageSystemANNIndexParts final : public IStorageSystemOneBlock
{
public:
    StorageSystemANNIndexParts(const StorageID & storage_id_, ColumnsDescription columns_description_);

    std::string getName() const override { return "SystemANNIndexParts"; }
