...
set(USE_DISKANN_CPP 0)
if (TARGET ch_contrib::diskann_cpp)
    set(USE_DISKANN_CPP 1)
endif()
set(USE_CPPDISKANN 0)
if (TARGET ch_contrib::cppdiskann)
    set(USE_CPPDISKANN 1)
endif()
