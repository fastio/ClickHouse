...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.4",
        {
            ...
            {"allow_experimental_auxiliary_index", false, false, "New experimental setting to gate creation and loading of `AuxiliaryIndex` tables."},
            {"enable_auxiliary_index", false, true, "New setting to enable query-plan optimization for AuxiliaryIndex tables."},
            {"force_using_auxiliary_index", false, false, "New setting to prefer AuxiliaryIndex over vector similarity indexes."},
            {"force_auxiliary_index", "", "", "New setting to force a specific AuxiliaryIndex by name."},
            {"disable_auxiliary_index", "", "", "New setting to disable a specific AuxiliaryIndex by name."},
            {"auxiliary_index_overfetch_factor", 4, 4, "New setting to control AuxiliaryIndex candidate overfetch."},
