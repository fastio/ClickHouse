...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.4",
        {
            ...
            {"allow_experimental_ann_index", false, false, "New experimental setting to gate creation and loading of `ANNIndex` tables."},
            {"enable_ann_index", false, true, "New setting to enable query-plan optimization for ANNIndex tables."},
            {"force_using_ann_index", false, false, "New setting to prefer ANNIndex over vector similarity indexes."},
            ...
            {"diskann_search_num_threads_ratio", 8.0, 8.0, "New DiskANN searcher open-time worker thread ratio; the effective worker count is min(available CPU cores * ratio, 64)."},
...
const VersionToSettingsChangesMap & getMergeTreeSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(merge_tree_settings_changes_history, "26.4",
        {
            ...
            {"ann_index_preferred_algorithm", "", "", "New source-table setting to prefer a default ANNIndex ANN algorithm during query optimization."},
        });
