...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    \
    M(ALTER_MATERIALIZED_INDEX_MODIFY_TYPE, "ALTER MATERIALIZED INDEX MODIFY TYPE", TABLE, ALTER_MATERIALIZED_INDEX) \
    M(ALTER_MATERIALIZED_INDEX_MODIFY_SETTING, "ALTER MATERIALIZED INDEX MODIFY SETTING", TABLE, ALTER_MATERIALIZED_INDEX) \
    M(ALTER_MATERIALIZED_INDEX_RESET_SETTING, "ALTER MATERIALIZED INDEX RESET SETTING", TABLE, ALTER_MATERIALIZED_INDEX) \
    M(ALTER_MATERIALIZED_INDEX_MODIFY_COMMENT, "ALTER MATERIALIZED INDEX MODIFY COMMENT", TABLE, ALTER_MATERIALIZED_INDEX) \
    M(ALTER_MATERIALIZED_INDEX, "", GROUP, ALTER) /* allows to execute ALTER MATERIALIZED INDEX; grouped alongside ALTER_VIEW */\
    \
    ...
    M(CREATE_MATERIALIZED_INDEX, "CREATE MATERIALIZED INDEX", TABLE, CREATE) /* allows to execute {CREATE|ATTACH} MATERIALIZED INDEX */\
    ...
    M(DROP_MATERIALIZED_INDEX, "DROP MATERIALIZED INDEX", TABLE, DROP) /* allows to execute {DROP|DETACH} MATERIALIZED INDEX */\
    ...
    M(SYSTEM_MATERIALIZED_INDEXES, "SYSTEM REFRESH MATERIALIZED INDEX, SYSTEM START MATERIALIZED INDEX BUILDS, SYSTEM STOP MATERIALIZED INDEX BUILDS, SYSTEM START MATERIALIZED INDEX REMAPS, SYSTEM STOP MATERIALIZED INDEX REMAPS, SYSTEM SYNC MATERIALIZED INDEX, REFRESH MATERIALIZED INDEX, START MATERIALIZED INDEX BUILDS, STOP MATERIALIZED INDEX BUILDS, START MATERIALIZED INDEX REMAPS, STOP MATERIALIZED INDEX REMAPS, SYNC MATERIALIZED INDEX", TABLE, SYSTEM) \
