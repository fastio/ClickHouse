...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    \
    M(ALTER_AUXILIARY_INDEX_MODIFY_SETTING, "ALTER AUXILIARY INDEX MODIFY SETTING", TABLE, ALTER_AUXILIARY_INDEX) \
    M(ALTER_AUXILIARY_INDEX_RESET_SETTING, "ALTER AUXILIARY INDEX RESET SETTING", TABLE, ALTER_AUXILIARY_INDEX) \
    M(ALTER_AUXILIARY_INDEX_MODIFY_COMMENT, "ALTER AUXILIARY INDEX MODIFY COMMENT", TABLE, ALTER_AUXILIARY_INDEX) \
    M(ALTER_AUXILIARY_INDEX, "", GROUP, ALTER) /* allows to execute ALTER AUXILIARY INDEX; grouped alongside ALTER_VIEW */\
    \
    ...
    M(CREATE_AUXILIARY_INDEX, "CREATE AUXILIARY INDEX", TABLE, CREATE) /* allows to execute {CREATE|ATTACH} AUXILIARY INDEX */\
    ...
    M(DROP_AUXILIARY_INDEX, "DROP AUXILIARY INDEX", TABLE, DROP) /* allows to execute {DROP|DETACH} AUXILIARY INDEX */\
    ...
    M(SYSTEM_AUXILIARY_INDEXES, "SYSTEM REFRESH AUXILIARY INDEX, SYSTEM START AUXILIARY INDEX BUILDS, SYSTEM STOP AUXILIARY INDEX BUILDS, SYSTEM START AUXILIARY INDEX REMAPS, SYSTEM STOP AUXILIARY INDEX REMAPS, SYSTEM SYNC AUXILIARY INDEX, REFRESH AUXILIARY INDEX, START AUXILIARY INDEX BUILDS, STOP AUXILIARY INDEX BUILDS, START AUXILIARY INDEX REMAPS, STOP AUXILIARY INDEX REMAPS, SYNC AUXILIARY INDEX", TABLE, SYSTEM) \
