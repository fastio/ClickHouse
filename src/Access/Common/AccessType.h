...
#define APPLY_FOR_ACCESS_TYPES(M) \
    ...
    M(CREATE_REFLECTION, "CREATE REFLECTION", TABLE, CREATE) /* allows to execute {CREATE|ATTACH} REFLECTION */\
    ...
    M(DROP_REFLECTION, "DROP REFLECTION", TABLE, DROP) /* allows to execute {DROP|DETACH} REFLECTION */\
    ...
    M(SYSTEM_REFLECTIONS, "SYSTEM REFRESH REFLECTION, SYSTEM START REFLECTION BUILDS, SYSTEM STOP REFLECTION BUILDS, SYSTEM START REFLECTION REMAPS, SYSTEM STOP REFLECTION REMAPS, SYSTEM SYNC REFLECTION, REFRESH REFLECTION, START REFLECTION BUILDS, STOP REFLECTION BUILDS, START REFLECTION REMAPS, STOP REFLECTION REMAPS, SYNC REFLECTION", TABLE, SYSTEM) \
