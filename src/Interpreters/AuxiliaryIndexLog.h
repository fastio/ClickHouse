...
struct AuxiliaryIndexLogElement
{
    ...
    std::vector<String> input_auxiliary_index_parts;
    String stage;
    ...
    static std::string name() { return "AuxiliaryIndexLog"; }
    static ColumnsDescription getColumnsDescription();
    static NamesAndAliases getNamesAndAliases() { return {}; }
    void appendToBlock(MutableColumns & columns) const;
};

class AuxiliaryIndexLog : public SystemLog<AuxiliaryIndexLogElement>
{
    using SystemLog<AuxiliaryIndexLogElement>::SystemLog;
};
