...
ColumnsDescription ANNIndexLogElement::getColumnsDescription()
{
    ...
    return ColumnsDescription
    {
        ...
        {"uuid", std::make_shared<DataTypeUUID>(), "UUID of the ann index."},
        ...
        {"input_ann_index_parts", std::make_shared<DataTypeArray>(std::make_shared<DataTypeString>()), "Materialized index part names consumed by the task."},
...
void ANNIndexLogElement::appendToBlock(MutableColumns & columns) const
{
    size_t i = 0;
    ...
    columns[i++]->insert(toArray(input_ann_index_parts));
