...
namespace Setting
{
    extern const SettingsBool allow_auxiliary_index_engine_mismatch;
}
    ...
    LoadingStrictnessLevel mode)
{
    ...
    {
        const bool escape = context->getSettingsRef()[Setting::allow_auxiliary_index_engine_mismatch];
        if (!escape)
        {
    ...
    AuxiliaryIndexContext mi_context{
