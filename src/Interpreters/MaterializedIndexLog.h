...
struct MaterializedIndexLogElement
{
...
class MaterializedIndexLog : public SystemLog<MaterializedIndexLogElement>
{
    using SystemLog<MaterializedIndexLogElement>::SystemLog;
};
