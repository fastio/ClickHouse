...
-- Single-replica coverage for `ReplicatedMaterializedIndex`: creation must
...
CREATE MATERIALIZED INDEX mi_repl_inner_idx
ON mi_repl_inner_src (embedding)
TYPE ann('diskann', metric = 'L2', dim = 4)
ENGINE = ReplicatedMaterializedIndex('/clickhouse/tables/{database}/mi_repl_inner_idx_04187', 'r1');
