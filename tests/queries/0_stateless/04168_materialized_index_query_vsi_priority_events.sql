...
-- force_using_materialized_index makes the MaterializedIndex optimizer
...
CREATE MATERIALIZED INDEX mi_query_vsi_priority
...
SYSTEM SYNC MATERIALIZED INDEX mi_query_vsi_priority;
...
LIMIT 1
FORMAT Null
SETTINGS force_using_materialized_index = 0, log_comment = 'mi_vsi_yields';

SELECT k FROM src_query_vsi_priority
ORDER BY L2Distance(embedding, [3.7, 0, 0, 0])
LIMIT 1
FORMAT Null
SETTINGS force_using_materialized_index = 1, log_comment = 'mi_vsi_preempts';
