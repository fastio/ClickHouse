...
SET force_materialized_index = 'mi_partial_select_vector';
SET log_queries = 1;
...
CREATE MATERIALIZED INDEX mi_partial_select_vector
...
SYSTEM SYNC MATERIALIZED INDEX mi_partial_select_vector;
