...
-- force_using_auxiliary_index makes the AuxiliaryIndex optimizer
...
LIMIT 1
FORMAT Null
SETTINGS force_using_auxiliary_index = 0, log_comment = 'mi_vsi_yields';

SELECT k FROM src_query_vsi_priority
ORDER BY L2Distance(embedding, [3.7, 0, 0, 0])
LIMIT 1
FORMAT Null
SETTINGS force_using_auxiliary_index = 1, log_comment = 'mi_vsi_preempts';
