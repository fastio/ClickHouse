...
DROP MATERIALIZED INDEX mi_plain_table; -- { serverError INCORRECT_QUERY }
...
DROP MATERIALIZED INDEX mi_idx SYNC;
...
SELECT name, family, impl FROM system.materialized_indexes
WHERE database = currentDatabase() AND name = 'mi_idx2';
