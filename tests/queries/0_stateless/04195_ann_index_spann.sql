...
SET force_ann_index = 'mi_spann_smoke';
...
-- Remap path: after source parts merge, the new ann-index part must keep
...
SELECT
    log_comment,
    max(ProfileEvents['ANNIndexSPANNSearchStarted'] > 0) AS used_spann_search
...
SET force_ann_index = 'mi_spann_cosine';
