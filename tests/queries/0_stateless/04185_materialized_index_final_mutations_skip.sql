...
-- MaterializedIndex fast path must not rewrite reads that need FINAL or on-the-fly mutations.
...
CREATE MATERIALIZED INDEX mi_final_mutations_skip
...
SYSTEM SYNC MATERIALIZED INDEX mi_final_mutations_skip;
