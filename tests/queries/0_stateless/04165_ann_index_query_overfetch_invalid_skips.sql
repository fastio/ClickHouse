...
LIMIT 1
FORMAT Null
SETTINGS force_ann_index = 'mi_query_overfetch_invalid', log_comment = 'mi_overfetch_valid_control';

SELECT k FROM src_query_overfetch_invalid
ORDER BY L2Distance(embedding, [41.7, 0, 0, 0])
LIMIT 1
FORMAT Null
SETTINGS force_ann_index = 'mi_query_overfetch_invalid', log_comment = 'mi_overfetch_oversize', ann_index_overfetch_factor = 1025;

SELECT k FROM src_query_overfetch_invalid
ORDER BY L2Distance(embedding, [41.7, 0, 0, 0])
LIMIT 1
FORMAT Null
SETTINGS force_ann_index = 'mi_query_overfetch_invalid', log_comment = 'mi_overfetch_zero', ann_index_overfetch_factor = 0;
