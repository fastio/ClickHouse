...
-- Legal overfetch factors must keep the MaterializedIndex fast path enabled.
...
CREATE MATERIALIZED INDEX mi_query_overfetch_valid
...
SYSTEM SYNC MATERIALIZED INDEX mi_query_overfetch_valid;
...
LIMIT 1
FORMAT Null
SETTINGS force_materialized_index = 'mi_query_overfetch_valid', log_comment = 'mi_overfetch_default';

SELECT k FROM src_query_overfetch_valid
ORDER BY L2Distance(embedding, [41.7, 0, 0, 0])
LIMIT 1
FORMAT Null
SETTINGS force_materialized_index = 'mi_query_overfetch_valid', log_comment = 'mi_overfetch_min', materialized_index_overfetch_factor = 1;

SELECT k FROM src_query_overfetch_valid
ORDER BY L2Distance(embedding, [41.7, 0, 0, 0])
LIMIT 1
FORMAT Null
SETTINGS force_materialized_index = 'mi_query_overfetch_valid', log_comment = 'mi_overfetch_max', materialized_index_overfetch_factor = 1024;
