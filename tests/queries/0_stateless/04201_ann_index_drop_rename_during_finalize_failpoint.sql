...
-- Exercises DROP / RENAME on a ANNIndex while a Build task is paused in
...
SYSTEM ENABLE FAILPOINT ann_index_build_pause_in_finish;

INSERT INTO src_drop_fp
SELECT number, [number * 1.0, number * 2.0, number * 3.0, number * 4.0]
FROM numbers(16);

SYSTEM WAIT FAILPOINT ann_index_build_pause_in_finish PAUSE;
...
SYSTEM DISABLE FAILPOINT ann_index_build_pause_in_finish;
