-- Verifies `system.materialized_index_parts` surfaces all expected fields,
...
CREATE MATERIALIZED INDEX mi_systable_idx
...
SYSTEM SYNC MATERIALIZED INDEX mi_systable_idx;
...
FROM system.materialized_index_parts AS mi
