...
-- ExpressionStep and ReadFromMergeTree; MaterializedIndex should still match it.

SET allow_experimental_materialized_index = 1;
SET enable_materialized_index = 1;
SET force_materialized_index = 'mi_where_filter';
SET log_queries = 1;
...
CREATE MATERIALIZED INDEX mi_where_filter
...
SYSTEM SYNC MATERIALIZED INDEX mi_where_filter;
...
LIMIT 1
FORMAT Null
SETTINGS materialized_index_require_match = 1, log_comment = 'mi_where_filter_depends_on_vector'; -- { serverError BAD_ARGUMENTS }
