...
-- disable_materialized_index drops the named MI from the candidate list before
...
CREATE MATERIALIZED INDEX mi_disable_a
...
CREATE MATERIALIZED INDEX mi_disable_b
ON src_disable (embedding)
TYPE ann('diskann', metric = 'L2', dim = 4)
ENGINE = MaterializedIndex
SETTINGS materialized_index_sync_timeout = 1;

SET disable_materialized_index = 'mi_disable_a';
