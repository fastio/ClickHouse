...
CREATE MATERIALIZED INDEX mi_repl_midloop_fp
ON src_repl_midloop_fp (embedding)
TYPE ann('diskann', metric = 'L2', dim = 4)
ENGINE = ReplicatedMaterializedIndex('/clickhouse/tables/{database}/mi_repl_midloop_fp_04204', 'r1')
...
SYSTEM SYNC MATERIALIZED INDEX mi_repl_midloop_fp;
...
SELECT
    materialized_index_part_count = 2 AS remap_outputs_committed_after_retry,
