...
CREATE MATERIALIZED INDEX mi_query_skip
...
SYSTEM SYNC MATERIALIZED INDEX mi_query_skip;
...
CREATE MATERIALIZED INDEX mi_query_skip_dim
...
LIMIT 1
FORMAT Null
SETTINGS enable_materialized_index = 0, log_comment = 'mi_skip_feature_off';
