...
-- Exercises DROP / RENAME on a MaterializedIndex while a Build task is paused in
...
CREATE MATERIALIZED INDEX mi_drop_fp
...
CREATE MATERIALIZED INDEX mi_rename_fp
...
DROP MATERIALIZED INDEX mi_drop_fp SYNC;
