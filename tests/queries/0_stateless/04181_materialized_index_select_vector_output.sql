...
SET force_materialized_index = 'mi_select_vector_output';
SET log_queries = 1;
...
CREATE MATERIALIZED INDEX mi_select_vector_output
...
SYSTEM SYNC MATERIALIZED INDEX mi_select_vector_output;
...
LIMIT 1
SETTINGS materialized_index_require_match = 1, log_comment = 'mi_select_vector_output';
...
LIMIT 1
FORMAT Null
SETTINGS materialized_index_require_match = 1, log_comment = 'mi_select_vector_where';
...
ORDER BY L2Distance(embedding, q)
LIMIT 1
SETTINGS materialized_index_require_match = 1, log_comment = 'mi_select_vector_filter_depends'; -- { serverError BAD_ARGUMENTS }
