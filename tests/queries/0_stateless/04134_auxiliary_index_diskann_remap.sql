...
-- source parts), `SYSTEM SYNC AUXILIARY INDEX` must again perform a
...
CREATE AUXILIARY INDEX mi_remap
...
SYSTEM SYNC AUXILIARY INDEX mi_remap; -- { serverError TIMEOUT_EXCEEDED }
