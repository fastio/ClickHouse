...
-- End-to-end correctness smoke for the DiskANN-backed MaterializedIndex
...
SET force_materialized_index = 'mi_smoke';
SET log_queries = 1;
...
CREATE MATERIALIZED INDEX mi_smoke
...
SYSTEM SYNC MATERIALIZED INDEX mi_smoke;
