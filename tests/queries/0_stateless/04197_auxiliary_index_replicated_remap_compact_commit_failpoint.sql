...
-- replicated `AuxiliaryIndex` Remap and Compact tasks. The failpoint makes
...
SETTINGS ann_metric = 'L2', ann_dimension = 4,
         ...
         auxiliary_index_compact_min_parts = 0;
...
SELECT
    auxiliary_index_part_count = 2 AS remap_outputs_visible_together,
...
FROM system.auxiliary_index_log
...
LIMIT 1
SETTINGS force_auxiliary_index = 'mi_repl_remap_fp';
...
SELECT
    auxiliary_index_part_count > 0 AS compact_has_part,
...
ORDER BY L2Distance(embedding, q)
LIMIT 1
SETTINGS force_auxiliary_index = 'mi_repl_compact_fp';
