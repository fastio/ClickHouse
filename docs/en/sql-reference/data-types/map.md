...
Both [`map_serialization_version`](/operations/settings/merge-tree-settings#map_serialization_version) and [`map_serialization_version_for_zero_level_parts`](/operations/settings/merge-tree-settings#map_serialization_version_for_zero_level_parts) must be `with_key_columns`. Setting only one of them is rejected.
